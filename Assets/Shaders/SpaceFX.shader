...
float4 UV_Pan0=float4((IN.uv_noise.xyxy).x + _Time.x,(IN.uv_noise.xyxy).y,(IN.uv_noise.xyxy).z + _Time.x,(IN.uv_noise.xyxy).w);
float4 Tex2D2=tex2D(_noise,UV_Pan0.xy);
float4 Multiply0=Tex2D0 * Tex2D2;
